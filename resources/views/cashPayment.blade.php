...
<body class="bg-gray-100">
    <div class="invoice max-w-4xl mx-auto bg-white p-6 shadow-md rounded-lg mt-10">
        <h2 class="text-2xl font-bold text-center mb-6">Ledok Sambi Ecopark</h2>
        <div class="mb-6">
            <p class="text-gray-700"><strong>Order ID:</strong> {{ $order->id }}</p>
            <p class="text-gray-700"><strong>Table Number:</strong> {{ $order->diningTable->number }}</p>
        ...
        <table class="w-full border-collapse">
            ...
            <tbody>
                ...
                <tr>
                    <td class="border border-gray-300 px-4 py-2">{{ ucfirst($detail->menu->name) }}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2 font-bold">{{ number_format($orderDetails->sum('total_amount'), 2) }}</td>
                </tr>
            </tfoot>
        </table>
        <div class="flex justify-center mt-2">
            <p class="text-gray-700 text-center mx-auto">Tunjukan nota ini ke kasir <br><b>Terimakasih</b> </p>
        </div>
    </div>
</body>
